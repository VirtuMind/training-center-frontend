...
export default function ProgressPage() {
  const totalHours = courseProgress.reduce((sum, course) => sum + course.timeSpent, 0)
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Track your learning journey and course completion</p>
      </div>
          ...
          <Card key={course.id}>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Progress tracking for this course</CardDescription>
                </div>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Progress value={Math.round((course.completedLessons / course.totalLessons) * 100)} className="h-2" />
